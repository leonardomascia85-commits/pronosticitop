(function () {
  ...
  function injectBanner() {
    ...
    el.style.cssText = 'position:fixed;left:16px;right:16px;bottom:16px;z-index:9999;max-width:640px;margin:0 auto;background:#ffffff;color:#1a1d24;border:1px solid #e1e4ea;border-radius:16px;padding:20px;font-family:Inter,-apple-system,Segoe UI,Roboto,Arial,sans-serif;font-size:14px;box-shadow:0 12px 32px rgba(20,25,35,.14)';
    el.innerHTML =
      '<p style="margin:0 0 14px;line-height:1.5">🍪 Usiamo cookie tecnici (sempre attivi), di analisi e pubblicitari (Google AdSense) per mostrare annunci pertinenti. Puoi scegliere quali accettare. Leggi la <a href="/cookie-policy.html" style="color:#3f6fb8">Cookie Policy</a>.</p>' +
      '<div style="display:flex;gap:10px;flex-wrap:wrap">' +
      '<button id="pt-accept-all" style="background:linear-gradient(135deg,#3f6fb8,#5a8ac9);color:#fff;border:none;border-radius:10px;padding:10px 18px;cursor:pointer;font-size:14px;font-weight:600;box-shadow:0 4px 16px rgba(63,111,184,.25)">Accetta tutti</button>' +
      '<button id="pt-reject-all" style="background:transparent;color:#1a1d24;border:1px solid #e1e4ea;border-radius:10px;padding:10px 18px;cursor:pointer;font-size:14px;font-weight:600">Solo necessari</button>' +
      '<button id="pt-customize" style="background:transparent;color:#5b6472;border:none;text-decoration:underline;padding:10px 4px;cursor:pointer;font-size:14px">Personalizza</button>' +
      '</div>';
